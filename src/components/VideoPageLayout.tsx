...
export function VideoPageLayout({
  ...
  // Normal mode - video player is always rendered once at the top level
  // Sticky behavior is controlled via CSS classes based on orientation
  // This prevents remounting when orientation changes (which would stop playback)
  return (
